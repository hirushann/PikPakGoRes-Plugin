...
var locationDataURL = 'http://web.elb.stg.pikpakgo.use1.aws.rezos.io/pikpakgoReservations/ComponentSupport.do?method=locationData';
...
loadFpkgCountryAutocomplete();
	...
	jQuery("#pickUpCity_H_Loc").bind( "autocompleteselect", function(event, ui) {
        ...
        jQuery("#dropOffCity_H_Loc").attr('disabled', false);
    });
	...
	jQuery("#pickUpCity_A_Loc").bind( "autocompleteselect", function(event, ui) {
        ...
        jQuery("#dropOffCity_A_Loc").attr('disabled', false);
    });
