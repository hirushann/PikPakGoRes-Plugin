      ...
      <div class="main_holder" id="hotelDisplay" style="display:block; ">
        <div class="bec_container_div cf" >
            <ul class="outer-container-ul">
              <div class="first-row-container">
                  <div class="residence-country-block">
                    ...
                    <div class="row7" id="h_search_type_div">
                      <div class="form-input-container">
                        <label class="option-sub-label radio-inputs hotelselect">
                      ...
                      <div class="form-input-container">
                        <label class="option-sub-label radio-inputs vacationselect">
                  ...
                  <div class="hotel-destination">
                    ...
                    <div class="row7 form-text-input-container">
                      ...
                      <input name="H_Loc" id="H_Loc" type="text" value="" placeholder="City or Location" size="20" validate="formH" require="Please Enter  Location" class="locationinput vacation-pink-theme user-country-select-hotel italic text-input"/>
                    ...
                    <ul class="hotel-date-time-block">
                      ...
                      <li class="width-fix-hotels">
                        <ul class="hotel-date-times">
                          <li class="hotel-date-time-li">
                            <div>
                              <label class="option-sub-label">Check -In</label>
                            </div>
                            <div class="start-date-input-container vacation-pink-theme">
                              <svg xmlns="http://www.w3.org/2000/svg" class="vacation-pink-themesvg calendarsvg" width="20" height="auto" fill="#FFF" viewBox="0 0 448 512"><path d="M128 0c17.7 0 32 14.3 32 32l0 32 128 0 0-32c0-17.7 14.3-32 32-32s32 14.3 32 32l0 32 48 0c26.5 0 48 21.5 48 48l0 48L0 160l0-48C0 85.5 21.5 64 48 64l48 0 0-32c0-17.7 14.3-32 32-32zM0 192l448 0 0 272c0 26.5-21.5 48-48 48L48 512c-26.5 0-48-21.5-48-48L0 192zm64 80l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16zm128 0l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0zM64 400l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0zm112 16l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16z"/></svg>
                          ...
                          <li class="width-night-width-fix">
                            ...
                            <div>
                              <select name="H_nights" id="H_nights" class="vacation-pink-theme hotel-day-select">
                          ...
                          <li class="hotel-date-time-li">
                            ...
                            <div class="end-date-input-container vacation-pink-theme">
                              <svg xmlns="http://www.w3.org/2000/svg" class="vacation-pink-themesvg calendarsvg" width="20" height="auto" fill="#FFF" viewBox="0 0 448 512"><path d="M128 0c17.7 0 32 14.3 32 32l0 32 128 0 0-32c0-17.7 14.3-32 32-32s32 14.3 32 32l0 32 48 0c26.5 0 48 21.5 48 48l0 48L0 160l0-48C0 85.5 21.5 64 48 64l48 0 0-32c0-17.7 14.3-32 32-32zM0 192l448 0 0 272c0 26.5-21.5 48-48 48L48 512c-26.5 0-48-21.5-48-48L0 192zm64 80l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16zm128 0l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0zM64 400l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0zm112 16l0 32c0 8.8 7.2 16 16 16l32 0c8.8 0 16-7.2 16-16l0-32c0-8.8-7.2-16-16-16l-32 0c-8.8 0-16 7.2-16 16z"/></svg>
                          ...
                          <li id="room_display_unit" class="width-night-width-fix" style='display:none'>
                            ...
                            <div>
                              <select id="norooms_H" name="norooms_H" class="vacation-pink-theme hotel-day-select" onChange="roomocc(this.id,this.value);resizeContainer();">
                ...
                <div class="ul-morefilters">
                  ...
                  <div class="hotel-morefilters" id="star_rating_div_H">
                    <div class=" textleft marginfix">
                      ...
                      <select id="star_rating_H" name="greeknumber" class="user-options-select row10 vacation-pink-theme">
                  ...
                  <div class="hotel-morefilters" id="hotel_name_H" >
                    <div class="marginfix textleft form-text-input-container">
                      ...
                      <input name="H_name" id="H_name" type="text" class="user-options-select row10 text-input vacation-pink-theme" onClick="return validate('formHN');" validate="formHN" require="Select hotel name from the dropdown for internal hotels only or type freeform name for both internal and/or third party inventory."/>
                  ...
                  <div class="hotel-morefilters" id="pref_cur_H" >
                    <div class="marginfix textleft">
                      <div id="h_curr_lbl_div">
                        ...
                        <select  name="H_consumerCurrencyCode" id="H_consumerCurrencyCode" class="user-options-select row10 vacation-pink-theme">
              ...
              <li class="cf"> 
                <a onClick="return validate('formH');"   href="JavaScript:search('H');" class="search-button">
                  <div id="search_btns_h" class="submit-button-pkpk vacation-pink-submit-btn">Search</div>
                </a> 
              </li>
            </ul>
        </div>
